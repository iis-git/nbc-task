...
Вам предстоит разработать мини-аналог Instagram – небольшое одностраничное веб-приложение, состоящее из сетки миниатюр изображений, при нажатии на каждое из которых должно открываться окно, содержащее изображения в полном размере, а также список комментариев к нему.<br>
